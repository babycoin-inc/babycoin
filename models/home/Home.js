...
exports.resetPortfolio = async (user_id) => {
  try {
    ...
    // KEEP THIS OR MODIFY HOW USER ACHIEVEMENT STATE IS CONSTRUCTED
    const updatedAchievements = await query('SELECT * FROM trader_achievements WHERE trader_id = $1', [user_id])
