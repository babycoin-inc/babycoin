...
const Login = ({ updateUser }) => {
  ...
  return (
    <div className='relative w-full max-h-max'>
      <img className='absolute w-full h-full mix-blend-overlay object-cover min-h-screen' src={bgImage} alt="bgImage" />
      <div className='flex justify-center items-center py-8'>
        <img className= 'w-48 h-48' src={babycoin} alt='babycoin'/>
      </div>
      <div className='flex justify-center items-center py-8'>
        <form className='max-w-[400px] w-full mx-auto  p-8 rounded-xl bg-white mix-blend-normal'>
