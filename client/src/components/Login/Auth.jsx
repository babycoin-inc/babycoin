  ...
  return (
    <div className={`relative w-full min-h-screen`}>
      ...
      <div className='bg-zinc-800 border-2 border-zinc-600 max-w-[450px] w-full -mt-14 mx-auto rounded-xl pb-10'> {/** h-[680px]*/}
        ...
        <div className='border-2 border-orange-700 max-w-[375px] bg-bitcoin-pattern rounded-xl mx-[37.5px] mt-10  text-zinc-200'> {/* -mt-14 */}

          {/* INFO BOX */}
          {infoIsShown ?
            <div id='infoContainer' className='px-8 py-[71px] text-center' > {/* className='px-9 py-[79px]' 79px keeps box from changing height between switching 'cards'*/}
