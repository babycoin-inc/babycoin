...
function Balance({ accountValue, profits, handleResetClick }) {
  ...
  return (
    <div className="flex flex-col w-5/12 p-6 bg-zinc-700 rounded-xl">
      ...
      {renderProfit}
      <button name="reset" onClick={handleResetClick} className="text-sm mt-8 bg-orange-400 text-orange-900 font-semibold border border-orange-500 rounded-3xl w-fit py-2 px-5 mx-auto hover:bg-zinc-800 hover:border-zinc-800 hover:text-orange-500 active:border active:border-orange-400">RESET TO $500</button>
    </div>
  )
}
