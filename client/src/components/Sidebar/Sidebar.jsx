...
function Sidebar({ handleNavClick, activePage, tradeHistory, userWatchlist, coins, removeFromWatchlist, authenticatedUser, handleCoinClick }) {
    ...
    <div className="w-64 border-r-2 border-zinc-800">
      <div className="sticky top-0">
        ...
        <div className="mt-28">
          ...
          <Watchlist userWatchlist={userWatchlist} coins={coins} removeFromWatchlist={removeFromWatchlist} authenticatedUser={authenticatedUser} handleCoinClick={handleCoinClick} />
        </div>
      </div>
     </div>
  )
