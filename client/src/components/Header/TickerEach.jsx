  ...
  return (
    <>
      <div className="flex px-3 py-1 hover:bg-green-900/50">
        ...
        <span className="px-1 font-bold	cursor-pointer" onClick={handleCoinClick}>{coin.name}</span>
        (<span className="cursor-pointer" onClick={handleCoinClick}>{coin.acronym.toUpperCase()}</span>)
