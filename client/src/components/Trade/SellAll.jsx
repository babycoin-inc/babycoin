...
function SellAll({coin, setOrderAmount, quantityOfCoin, orderUnits, roundNumUpToDigit, setSellAll, sellAll}) {
  ...
  return (
        <button disabled={sellAll} name="sellAll" className={`text-center bg-zinc-400 rounded-xl hover:bg-zinc-500 py-2 px-10 mx-auto relative left-5 ${sellAll ? 'border border-2 border-green-500 py-2 px-10 mx-auto' : undefined}`} onClick={() => {
